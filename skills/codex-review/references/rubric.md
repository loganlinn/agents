...
* Write the complete JSON object to the output file specified in the skill instructions. Do not print the JSON to the chat or wrap it in prose. The file is the sole delivery channel for the structured review result.
